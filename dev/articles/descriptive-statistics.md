...
1.  **[`describe()`](https://YannickDiehl.github.io/mariposa/dev/reference/describe.md)**
    gives you a full picture of numeric variables
2.  **[`frequency()`](https://YannickDiehl.github.io/mariposa/dev/reference/frequency.md)**
    shows the distribution of categorical variables
3.  **[`crosstab()`](https://YannickDiehl.github.io/mariposa/dev/reference/crosstab.md)**
