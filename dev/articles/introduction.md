...
|---------------------|-------------------------------------------------------------------------------------------|-------------------------------------------|
| Summarize numeric   | [`describe()`](https://YannickDiehl.github.io/mariposa/dev/reference/describe.md)         | `describe(age, income)`                   |
| Count categories    | [`frequency()`](https://YannickDiehl.github.io/mariposa/dev/reference/frequency.md)       | `frequency(education)`                    |
| Compare 2 groups    | [`t_test()`](https://YannickDiehl.github.io/mariposa/dev/reference/t_test.md)             | `t_test(income, group = gender)`          |
| Compare 3+ groups   | [`oneway_anova()`](https://YannickDiehl.github.io/mariposa/dev/reference/oneway_anova.md) | `oneway_anova(income, group = education)` |
| Test association    | [`chi_square()`](https://YannickDiehl.github.io/mariposa/dev/reference/chi_square.md)     | `chi_square(education, employment)`       |
| Measure correlation | [`pearson_cor()`](https://YannickDiehl.github.io/mariposa/dev/reference/pearson_cor.md)   | `pearson_cor(age, income)`                |
| Cross-tabulate      | [`crosstab()`](https://YannickDiehl.github.io/mariposa/dev/reference/crosstab.md)         | `crosstab(education, region)`             |
