...
- **Yannick Diehl**. Author, maintainer.
...
Analysis - Statistical Tools for Survey Data*. R package version
0.5.2.4, <https://YannickDiehl.github.io/mariposa/>.
    ...
    @Manual{,
      ...
      year = {2026},
      note = {R package version 0.5.2.4},
