...
#>  outcome_score 26.224  26.36 3.352 14.937 4.466   -0.387 60       0
#> ----------------------------------------
#> 
...
#> ----------------------------------------
#>       Variable   Mean Median    SD  Range   IQR Skewness  N Missing
#>  outcome_score 26.996 27.505 2.749 11.326 4.418   -0.508 51       9
#> ----------------------------------------
#> 
...
#> ----------------------------------------
#>       Variable  Mean Median    SD  Range   IQR Skewness  N Missing
#>  outcome_score 27.46 27.901 2.865 11.694 4.963   -0.081 49      11
#> ----------------------------------------
#> 
...
#> ----------------------------------------
#>       Variable   Mean Median    SD  Range   IQR Skewness  N Missing
#>  outcome_score 27.944 28.253 3.452 14.255 4.756   -0.334 41      19
#> ----------------------------------------
#> 
...
#> ----------------------------------------
#>       Variable   Mean Median    SD  Range   IQR Skewness  N Missing
#>  outcome_score 25.216 25.328 3.924 17.558 4.457   -0.098 59       1
#> ----------------------------------------
#> 
...
#> ----------------------------------------
#>       Variable   Mean Median  SD  Range   IQR Skewness  N Missing
#>  outcome_score 27.078 27.087 4.2 20.332 5.596    0.189 55       5
#> ----------------------------------------
#> 
...
#> ----------------------------------------
#>       Variable   Mean Median    SD  Range   IQR Skewness  N Missing
#>  outcome_score 29.288 29.515 3.619 15.305 5.903    0.211 48      12
#> ----------------------------------------
#> 
...
#> ----------------------------------------
#>       Variable   Mean Median    SD  Range   IQR Skewness  N Missing
#>  outcome_score 30.826 30.552 3.059 11.133 5.117     0.25 37      23
#> ----------------------------------------
```
