...
37 functions for descriptive statistics, hypothesis testing, correlation
analysis, post-hoc comparisons, weighted statistics, scale analysis,
regression, and non-parametric tests. All results are validated against
SPSS v29 for reproducibility. Designed for survey researchers, social
scientists, and students working with complex survey designs.
