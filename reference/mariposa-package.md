...
76 functions for data import/export (SPSS, Stata, SAS, Excel) with label
...
analysis, regression, non-parametric tests, exact tests, factorial
ANOVA, and ANCOVA. Every analysis offers compact print() and detailed
summary() output with toggleable sections. All results are validated
against SPSS v29 for reproducibility. Designed for survey researchers,
social scientists, and students working with complex survey designs.
