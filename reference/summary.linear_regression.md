...
- conf_int:
  ...
  Logical. Show the confidence-interval columns for B in the
  coefficients table (SPSS `/STATISTICS CI`)? The interval level is the
...
#>   --------------------------------------------------------------------------------------------------------------
#>   (Intercept)                    3.711      0.093              39.828    0.000      3.528      3.894 ***
#>   age                           -0.002      0.001   -0.025     -1.208    0.227     -0.004      0.001 
#>   trust_government               0.006      0.021    0.006      0.305    0.760     -0.034      0.047 
#>   --------------------------------------------------------------------------------------------------------------
#> 
