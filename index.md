...
provides 80 functions for importing, managing, transforming, and
...
| **Descriptive** | [`describe()`](https://YannickDiehl.github.io/mariposa/reference/describe.md), [`frequency()`](https://YannickDiehl.github.io/mariposa/reference/frequency.md), [`crosstab()`](https://YannickDiehl.github.io/mariposa/reference/crosstab.md), [`multiple_response()`](https://YannickDiehl.github.io/mariposa/reference/multiple_response.md), [`codebook()`](https://YannickDiehl.github.io/mariposa/reference/codebook.md) | Summaries, distributions, multiple response sets, data dictionaries |
| **Assumption checks** | [`normality_test()`](https://YannickDiehl.github.io/mariposa/reference/normality_test.md) | Kolmogorov-Smirnov (Lilliefors) and Shapiro-Wilk normality tests |
...
| **Correlation** | [`pearson_cor()`](https://YannickDiehl.github.io/mariposa/reference/pearson_cor.md), [`spearman_rho()`](https://YannickDiehl.github.io/mariposa/reference/spearman_rho.md), [`kendall_tau()`](https://YannickDiehl.github.io/mariposa/reference/kendall_tau.md), [`partial_cor()`](https://YannickDiehl.github.io/mariposa/reference/partial_cor.md) | Relationships between variables, with and without controls |
...
| **Regression** | [`linear_regression()`](https://YannickDiehl.github.io/mariposa/reference/linear_regression.md), [`logistic_regression()`](https://YannickDiehl.github.io/mariposa/reference/logistic_regression.md), [`marginal_effects()`](https://YannickDiehl.github.io/mariposa/reference/marginal_effects.md) | Linear and logistic models with SPSS-style output, average marginal effects |
