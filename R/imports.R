...
#' @importFrom stats var sd median quantile IQR na.omit complete.cases TukeyHSD aov as.formula ave chisq.test confint cor lm oneway.test pf pnorm pt ptukey qf qnorm qt qtukey t.test weighted.mean wilcox.test xtabs
