...
#' @importFrom stats var sd median quantile IQR na.omit complete.cases TukeyHSD anova aov as.formula ave binomial chisq.test confint cor fitted glm lm logLik oneway.test pchisq pf pnorm pt ptukey qf qnorm qt qtukey t.test varimax weighted.mean wilcox.test xtabs
