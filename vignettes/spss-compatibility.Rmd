...
validation exception registry. See
[Validation Charter](https://github.com/YannickDiehl/mariposa/blob/main/.claude/VALIDATION_CHARTER.md)
...
- **Spec** — same closed-form formula; tolerance `±1e-5` (statistics) or `±1e-4` (p-values)
...
R-side computation matches via
[`assert_spss()`](https://github.com/YannickDiehl/mariposa/blob/main/tests/testthat/helper-validation-tolerances.R).
