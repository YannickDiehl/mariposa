...
OMS
  /IF SUBTYPES=['Homogeneous Subsets']
  /DESTINATION FORMAT=TEXT OUTFILE='/Users/yannickdiehl/Documents/SoftwareProjekte/RPakete/SurveyStat/tests/spss_reference/outputs/tukey_test_output.txt'.
