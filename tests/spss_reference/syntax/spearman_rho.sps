...
TITLE 'Spearman Rho: Life satisfaction, Political orientation, Trust media'.
NONPAR CORR
...
TITLE 'Spearman Rho: Income, Age, Life satisfaction'.
NONPAR CORR
...
TITLE 'Spearman Rho: Trust government, Trust media, Trust science'.
NONPAR CORR
...
TITLE 'Spearman Rho: Political orientation with trust variables'.
NONPAR CORR
...
TITLE 'Spearman Rho: Income and Age'.
NONPAR CORR
...
TITLE 'Spearman Rho: Comprehensive variable set'.
NONPAR CORR
...
TITLE 'Spearman Rho: Life satisfaction, Political orientation, Trust media (weighted)'.
NONPAR CORR
  /VARIABLES=life_satisfaction political_orientation trust_media
  /PRINT=SPEARMAN TWOTAIL NOSIG
  /MISSING=PAIRWISE.
...
TITLE 'Spearman Rho: Income, Age, Life satisfaction (weighted)'.
NONPAR CORR
  /VARIABLES=income age life_satisfaction
  /PRINT=SPEARMAN TWOTAIL NOSIG
  /MISSING=PAIRWISE.
...
TITLE 'Spearman Rho: Trust government, Trust media, Trust science (weighted)'.
NONPAR CORR
  /VARIABLES=trust_government trust_media trust_science
  /PRINT=SPEARMAN TWOTAIL NOSIG
  /MISSING=PAIRWISE.
...
TITLE 'Spearman Rho: Political orientation with trust variables (weighted)'.
NONPAR CORR
  /VARIABLES=political_orientation trust_government trust_media trust_science
  /PRINT=SPEARMAN TWOTAIL NOSIG
  /MISSING=PAIRWISE.
...
TITLE 'Spearman Rho: Income and Age (weighted)'.
NONPAR CORR
  /VARIABLES=income age
  /PRINT=SPEARMAN TWOTAIL NOSIG
  /MISSING=PAIRWISE.
...
TITLE 'Spearman Rho: Comprehensive variable set (weighted)'.
NONPAR CORR
  /VARIABLES=life_satisfaction income age political_orientation environmental_concern
  /PRINT=SPEARMAN TWOTAIL NOSIG
  /MISSING=PAIRWISE.
...
TITLE 'Spearman Rho: Life satisfaction, Political orientation, Trust media (grouped by region)'.
NONPAR CORR
  /VARIABLES=life_satisfaction political_orientation trust_media
  /PRINT=SPEARMAN TWOTAIL NOSIG
  /MISSING=PAIRWISE.
...
TITLE 'Spearman Rho: Income, Age, Life satisfaction (grouped by region)'.
NONPAR CORR
  /VARIABLES=income age life_satisfaction
  /PRINT=SPEARMAN TWOTAIL NOSIG
  /MISSING=PAIRWISE.
...
TITLE 'Spearman Rho: Trust variables (grouped by region)'.
NONPAR CORR
  /VARIABLES=trust_government trust_media trust_science
  /PRINT=SPEARMAN TWOTAIL NOSIG
  /MISSING=PAIRWISE.
...
TITLE 'Spearman Rho: Income and Age (grouped by region)'.
NONPAR CORR
  /VARIABLES=income age
  /PRINT=SPEARMAN TWOTAIL NOSIG
  /MISSING=PAIRWISE.
...
TITLE 'Spearman Rho: Life satisfaction, Political orientation, Trust media (weighted, grouped by region)'.
NONPAR CORR
  /VARIABLES=life_satisfaction political_orientation trust_media
  /PRINT=SPEARMAN TWOTAIL NOSIG
  /MISSING=PAIRWISE.
...
TITLE 'Spearman Rho: Income, Age, Life satisfaction (weighted, grouped by region)'.
NONPAR CORR
  /VARIABLES=income age life_satisfaction
  /PRINT=SPEARMAN TWOTAIL NOSIG
  /MISSING=PAIRWISE.
...
TITLE 'Spearman Rho: Trust variables (weighted, grouped by region)'.
NONPAR CORR
  /VARIABLES=trust_government trust_media trust_science
  /PRINT=SPEARMAN TWOTAIL NOSIG
  /MISSING=PAIRWISE.
...
TITLE 'Spearman Rho: Income and Age (weighted, grouped by region)'.
NONPAR CORR
  /VARIABLES=income age
  /PRINT=SPEARMAN TWOTAIL NOSIG
  /MISSING=PAIRWISE.
