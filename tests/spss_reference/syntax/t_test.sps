* Encoding: UTF-8.
* SPSS Syntax for T-Test Validation
* Dataset: survey_data.sav
* Purpose: Validate t_test() function against SPSS results
* Created: 2024-09-23
...
OMS
  /IF SUBTYPES=['One-Sample Statistics' 'One-Sample Test' 'Group Statistics' 'Independent Samples Test']
  /DESTINATION FORMAT=TEXT OUTFILE='/Users/yannickdiehl/Documents/SoftwareProjekte/RPakete/SurveyStat/tests/spss_reference/outputs/t_test_output.txt'.
...
SUBTITLE 'One-Sample T-Test: Life Satisfaction (mu = 3.0)'.
T-TEST
  /TESTVAL=3.0
  /MISSING=ANALYSIS
...
SUBTITLE 'Independent Samples T-Test: Life Satisfaction by Gender'.
...
SUBTITLE 'Independent Samples T-Test: Income by Gender'.
T-TEST GROUPS=gender('Male' 'Female')
  /MISSING=ANALYSIS
  /VARIABLES=income
  /CRITERIA=CI(.95).
...
SUBTITLE 'Independent Samples T-Test: Age by Gender'.
T-TEST GROUPS=gender('Male' 'Female')
  /MISSING=ANALYSIS
  /VARIABLES=age
  /CRITERIA=CI(.95).
...
SUBTITLE 'One-Sample T-Test: Life Satisfaction (weighted, mu = 3.0)'.
T-TEST
  /TESTVAL=3.0
  /MISSING=ANALYSIS
  /VARIABLES=life_satisfaction
...
SUBTITLE 'Independent Samples T-Test: Life Satisfaction by Gender (weighted)'.
T-TEST GROUPS=gender('Male' 'Female')
  /MISSING=ANALYSIS
  /VARIABLES=life_satisfaction
  /CRITERIA=CI(.95).
...
SUBTITLE 'Independent Samples T-Test: Income by Gender (weighted)'.
T-TEST GROUPS=gender('Male' 'Female')
  /MISSING=ANALYSIS
  /VARIABLES=income
  /CRITERIA=CI(.95).
...
SUBTITLE 'Independent Samples T-Test: Age by Gender (weighted)'.
T-TEST GROUPS=gender('Male' 'Female')
  /MISSING=ANALYSIS
  /VARIABLES=age
  /CRITERIA=CI(.95).
...
SUBTITLE 'Independent Samples T-Test: Life Satisfaction by Gender (grouped by region)'.
T-TEST GROUPS=gender('Male' 'Female')
  /MISSING=ANALYSIS
  /VARIABLES=life_satisfaction
  /CRITERIA=CI(.95).
...
SUBTITLE 'Independent Samples T-Test: Income by Gender (grouped by region)'.
T-TEST GROUPS=gender('Male' 'Female')
  /MISSING=ANALYSIS
  /VARIABLES=income
  /CRITERIA=CI(.95).
...
SUBTITLE 'Independent Samples T-Test: Age by Gender (grouped by region)'.
T-TEST GROUPS=gender('Male' 'Female')
  /MISSING=ANALYSIS
  /VARIABLES=age
  /CRITERIA=CI(.95).
...
SUBTITLE 'Independent Samples T-Test: Life Satisfaction by Gender (weighted, grouped by region)'.
T-TEST GROUPS=gender('Male' 'Female')
  /MISSING=ANALYSIS
  /VARIABLES=life_satisfaction
  /CRITERIA=CI(.95).
...
SUBTITLE 'Independent Samples T-Test: Income by Gender (weighted, grouped by region)'.
T-TEST GROUPS=gender('Male' 'Female')
  /MISSING=ANALYSIS
  /VARIABLES=income
  /CRITERIA=CI(.95).
...
SUBTITLE 'Independent Samples T-Test: Age by Gender (weighted, grouped by region)'.
T-TEST GROUPS=gender('Male' 'Female')
  /MISSING=ANALYSIS
  /VARIABLES=age
  /CRITERIA=CI(.95).
...
TITLE '=========== Test 5a ==========='.
SUBTITLE 'One-Sample T-Test: Income (mu = 5000)'.
T-TEST
  /TESTVAL=5000
  /MISSING=ANALYSIS
  /VARIABLES=income
...
TITLE '=========== Test 5b ==========='.
SUBTITLE 'One-Sample T-Test: Age (mu = 45)'.
T-TEST
  /TESTVAL=45
  /MISSING=ANALYSIS
  /VARIABLES=age
...
TITLE '=========== Test 6 ==========='.
SUBTITLE 'Multiple Variables T-Test by Gender'.
T-TEST GROUPS=gender('Male' 'Female')
  /MISSING=ANALYSIS
