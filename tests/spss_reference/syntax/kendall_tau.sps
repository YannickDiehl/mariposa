...
SUBTITLE 'Kendall Tau: Life satisfaction, Political orientation, Trust media'.
NONPAR CORR
...
SUBTITLE 'Kendall Tau: Income, Age, Life satisfaction'.
NONPAR CORR
...
SUBTITLE 'Kendall Tau: Trust government, Trust media, Trust science'.
NONPAR CORR
...
SUBTITLE 'Kendall Tau: Political orientation with trust variables'.
NONPAR CORR
...
SUBTITLE 'Kendall Tau: Income and Age'.
NONPAR CORR
...
SUBTITLE 'Kendall Tau: Comprehensive variable set'.
NONPAR CORR
...
SUBTITLE 'Kendall Tau: Life satisfaction, Political orientation, Trust media (weighted)'.
NONPAR CORR
  /VARIABLES=life_satisfaction political_orientation trust_media
  /PRINT=KENDALL TWOTAIL NOSIG
  /MISSING=PAIRWISE.
...
SUBTITLE 'Kendall Tau: Income, Age, Life satisfaction (weighted)'.
NONPAR CORR
  /VARIABLES=income age life_satisfaction
  /PRINT=KENDALL TWOTAIL NOSIG
  /MISSING=PAIRWISE.
...
SUBTITLE 'Kendall Tau: Trust government, Trust media, Trust science (weighted)'.
NONPAR CORR
  /VARIABLES=trust_government trust_media trust_science
  /PRINT=KENDALL TWOTAIL NOSIG
  /MISSING=PAIRWISE.
...
SUBTITLE 'Kendall Tau: Political orientation with trust variables (weighted)'.
NONPAR CORR
  /VARIABLES=political_orientation trust_government trust_media trust_science
  /PRINT=KENDALL TWOTAIL NOSIG
  /MISSING=PAIRWISE.
...
SUBTITLE 'Kendall Tau: Income and Age (weighted)'.
NONPAR CORR
  /VARIABLES=income age
  /PRINT=KENDALL TWOTAIL NOSIG
  /MISSING=PAIRWISE.
...
SUBTITLE 'Kendall Tau: Comprehensive variable set (weighted)'.
NONPAR CORR
  /VARIABLES=life_satisfaction income age political_orientation environmental_concern
  /PRINT=KENDALL TWOTAIL NOSIG
  /MISSING=PAIRWISE.
...
SUBTITLE 'Kendall Tau: Life satisfaction, Political orientation, Trust media (grouped by region)'.
NONPAR CORR
  /VARIABLES=life_satisfaction political_orientation trust_media
  /PRINT=KENDALL TWOTAIL NOSIG
  /MISSING=PAIRWISE.
...
SUBTITLE 'Kendall Tau: Income, Age, Life satisfaction (grouped by region)'.
NONPAR CORR
  /VARIABLES=income age life_satisfaction
  /PRINT=KENDALL TWOTAIL NOSIG
  /MISSING=PAIRWISE.
...
SUBTITLE 'Kendall Tau: Trust variables (grouped by region)'.
NONPAR CORR
  /VARIABLES=trust_government trust_media trust_science
  /PRINT=KENDALL TWOTAIL NOSIG
  /MISSING=PAIRWISE.
...
SUBTITLE 'Kendall Tau: Income and Age (grouped by region)'.
NONPAR CORR
  /VARIABLES=income age
  /PRINT=KENDALL TWOTAIL NOSIG
  /MISSING=PAIRWISE.
...
SUBTITLE 'Kendall Tau: Life satisfaction, Political orientation, Trust media (weighted, grouped by region)'.
NONPAR CORR
  /VARIABLES=life_satisfaction political_orientation trust_media
  /PRINT=KENDALL TWOTAIL NOSIG
  /MISSING=PAIRWISE.
...
SUBTITLE 'Kendall Tau: Income, Age, Life satisfaction (weighted, grouped by region)'.
NONPAR CORR
  /VARIABLES=income age life_satisfaction
  /PRINT=KENDALL TWOTAIL NOSIG
  /MISSING=PAIRWISE.
...
SUBTITLE 'Kendall Tau: Trust variables (weighted, grouped by region)'.
NONPAR CORR
  /VARIABLES=trust_government trust_media trust_science
  /PRINT=KENDALL TWOTAIL NOSIG
  /MISSING=PAIRWISE.
...
SUBTITLE 'Kendall Tau: Income and Age (weighted, grouped by region)'.
NONPAR CORR
  /VARIABLES=income age
  /PRINT=KENDALL TWOTAIL NOSIG
  /MISSING=PAIRWISE.
