...
OMS
  /IF SUBTYPES=['Friedman Test' 'Test Statistics' 'Ranks']
...
* Note: longitudinal_data.sav may be in long format (480 rows).
...
* Adjust variable names below if needed.

* If already in wide format with score_T1 through score_T4:
